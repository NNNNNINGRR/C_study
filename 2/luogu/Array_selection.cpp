...
int main(int argc , char* args[])
{
    ...
    for(int i=0;i<matrix.size();i++)
    {
        ...
        c[2]=tmp[2]%10;
        if(a0[0]==b[0]||a0[0]==b[1]||a0[0]==b[2]||a0[1]==b[0]\
        ||a0[1]==b[1]||a0[1]==b[2]||a0[2]==b[0]||a0[2]==b[1]\
        ||a0[2]==b[2]||a0[0]==c[0]||a0[0]==c[1]||a0[0]==c[2]\
        ||a0[1]==c[0]||a0[1]==c[1]||a0[1]==c[2]||a0[2]==c[0]\
        ||a0[2]==c[1]||a0[2]==c[2]||b[0]==c[0]||b[0]==c[1]\
        ||b[0]==c[2]||b[1]==c[0]||b[1]==c[1]||b[1]==c[2]\
